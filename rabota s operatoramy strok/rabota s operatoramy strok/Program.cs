...
namespace rabota_s_operatoramy_strok
{
	class CompareDemo
	{
		static void Main()
		{
			...
			// с учетом порядкового сравнения.
			...
			StringComparison.CurrentCulture) > 0)
			{
				...
				Console.WriteLine("Выполняет поиск индекса строки");
			int indexOf = str1.IndexOf(str4); // равно 0
				Console.WriteLine($"Индекс строки равен: {indexOf}");
